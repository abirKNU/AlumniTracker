...
$imgslider = array  
  (  
  array("UITS Alumni","imgslider/slider image 13.jpg"),
  array("UITS Alumni","imgslider/slider image 12.jpg"),
  array("UITS Alumni","imgslider/slider image 11.jpg"),
  );  
?>
<!-- Top News Start-->
<div class="top-news">
...
<div class="col-md-6 tn-right">
	...
	?>
		<div class="col-md-6">
			<div class="tn-img"   style="width: 70%;height: 172px;">
                        ...
                        <div class="tab-content">
                            <div id="featured" class="container tab-pane active">
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        Alumni of an organizations generally stay in touch with their immediate friends but find it hard to stay connected with other college mates. Contact between alumni can be used to forge business connections and to gain references or insight in a new field. Alumni work can consist of alumni mentoring students, organizing alumni days, having training sessions during alumni days for alumni, inviting alumni to give lectures, arranging work practices, and proposing topics of theses, raise funds for the organizations. It is important to carry out a good follow-up marketing of alumni events.
                                    </div>
                                </div>
                            </div>
