...
define("PROTITLE", "UITS Alumni Finder");
define("PROADDR", "University of Information Technology and Sciences (UITS), Holding 190, Road 5, Block J, Baridhara, Maddha, Naya Nagar Rd, Dhaka 1212");
define("PROEMAIL", "info@uits.edu.bd");
define("PROPHNO", "+880-1713-487709");
define("PRODEVELOPER", "Dept. of IT,UITS");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-4">
                        <div class="b-logo">
                            <a href="index.php">
                                <img src="img/UITS logo.png" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4">
...
<div class="nav-item dropdown">
	...
	<div class="dropdown-menu">
		...
		<a href="managecourse.php" class="dropdown-item">Manage Department</a>
	</div>
</div>
...
?>
                        <div class="social ml-auto">
                            <a href="https://www.facebook.com/SJECMangaluru/"><i class="fab fa-facebook-f"></i></a>
                            <a href="https://twitter.com/SJEC_Mangaluru?s=08"><i class="fab fa-twitter"></i></a>
                            <a href="https://www.instagram.com/official_sjec_mangaluru/"><i class="fab fa-instagram"></i></a>
                            <a href="https://www.youtube.com/channel/UCUI7tBByrJ-T1cdN_CrifIg?view_as=subscriber"><i class="fab fa-youtube"></i></a>
                        </div>
<?php
}
?>
