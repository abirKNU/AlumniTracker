...
if(isset($_POST['submit']))
{
	...
	$sql = "insert into alumni(name,reg_no,pass_yr,courseid,status) values ('".$_POST['Name']."','".$_POST['enrollment_no_entry']."','".$_POST['Passing_Out_year']."','".$_POST['course']."','Pending')";
		...
		<div id="featured" class="container tab-pane active">
			<div class="tn-news row">
				...
				<div class="col-md-6">
					...
					<input type="text" class="form-control" id="enrollment_no_entry" name="enrollment_no_entry" placeholder="Enrollment No." >
				</div>
				<div class="col-md-6">
