		...
		<div id="featured" class="container tab-pane active">
			<div class="tn-news row">
				...
				<div class="col-md-6">
					...
					<input type="number" class="form-control" id="reg_no" name="reg_no" placeholder="Registration No." value="<?php echo $rsedit['reg_no']; ?>"  >
				</div>
				<div class="col-md-6">
...
function validateform()
{
	 ...
	 if(document.getElementById("reg_no").value.length != 10)
	{
