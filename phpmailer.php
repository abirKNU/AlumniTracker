...
{
	$loginid 	= "alumnitracker@technopulse.cyou";
	$password 	= "t?IQ@z?MLz5n";
	...
	$companyaddress  = "Alumni, University of Information Technology and Sciences (UITS), Holding 190, Road 5, Block J, Baridhara, Maddha, Naya Nagar Rd, Dhaka 1212 Email Us : info@uits.edu.bd";
	$contactno = "+880-1713-487709";
	$url = "www.alumni.bd";
